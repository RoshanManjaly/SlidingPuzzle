...
public class PuzzleGameGUI extends Frame implements ActionListener, MouseListener, MouseMotionListener, ItemListener {
	 ...
	 * 
	 * @param f
	 *            is the file to load the image from
	 */
	 ...
	 * 
	 * @param image
	 *            whose pieces are used to put on display
	 */
	 ...
	 *            has a range 1,2,...,15
	 * @param image
	 *            is the image fragment to store
	 */
	 ...
	 * 
	 * @param e
	 *            provides information for the event, e.g. if user clicked on the
	 *            frame or the board.
	 */
	@Override
	 ...
	 * 
	 * @param e
	 *            provides information for the event, not used here
	 */
	@Override
	...
	public void mouseDragged(MouseEvent e) {
		if (drag.getState()) {
			if (selectedSquare != null) {
				// Selects checksquare if it is valid on the plane, not the selected square, and
				// not an already checked square.
	 ...
	 * 
	 * @param p
	 *            carries (x=column,y=row) coordinates
	 ...
	 * 
	 * @param p
	 *            graphics point selected on window
	...
	/**
	 * Checks if a given position as pixel coordinates is on the board and not on
	 * the frame.
	 * 
	 * @param p
	 ...
	 * 
	 * @param p
	 *            encodes current row, column coordinates
